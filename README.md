...
If the Mles Websocket session is connected to [arki-server](https://github.com/jq-rs/arki-server) proxy, it will forward the traffic to Mles server transforming it to strong AES and vice versa, which also should be secure.
