...
Message data sent is obfuscated end-to-end using symmetrical Blowfish (56-bit key, weak encryption) [2] with CTS [3] + AONT [4] and Blake2 [5] HMAC. Using weak encryption with data avoids the [need for registration](https://www.eff.org/deeplinks/2019/08/us-export-controls-and-published-encryption-source-code-explained) when this library is part of an application in a global app store.
